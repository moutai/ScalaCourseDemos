...
object numbers {
  val in = Source.fromURL("https://raw.github.com/moutai/ScalaCourseDemos/master/linuxwords")
  ...
  encode("722234234")                             //> res1: Set[List[String]] = Set()

  def translate(number: String): Set[String] =
    encode(number) map (_ mkString " ")           //> translate: (number: String)Set[String]
	
	translate("722524")                       //> res2: Set[String] = Set(pack ah, rack ah, sack ah)
}